...
function drawImageCover(ctx, img, W, H) {
  ...
  ctx.save();
  ctx.beginPath();
  ctx.rect(0, 0, W, Math.round(H * 0.93));
  ctx.clip();
    ...
    <div ref={containerRef} style={{ height: "220vh", position: "relative" }}>
      <div className="sticky top-0 overflow-hidden" style={{ height: "100vh", fontFamily: FONT_BODY }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 pointer-events-none"
          style={{ zIndex: 2, height: "18%", background: `linear-gradient(to bottom, transparent 0%, ${C.bg} 100%)` }} />
...
function CategorySection({ onNav }) {
  ...
  return (
    <div style={{ overflow: "visible", background: C.bg }}>
      <section ref={sectionRef} className="max-w-7xl mx-auto px-5 sm:px-8 py-6">
